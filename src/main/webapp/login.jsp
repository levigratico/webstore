      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <div class="row">
                ...
                <div class="col col s8 m8 l8">
                    <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown">Levi Â <i class="mdi-navigation-arrow-drop-down right"></i></a>
                    ...
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-invitation"></i> Orders</a>
                            <div class="collapsible-body">
                                <ul>
								<li class="active"><a href="orders.jsp">All Orders</a>
                                </li>
...
<div id="work-collections" class="seaction">
					...
					<div class="row">
						...
						<li class="collection-item avatar">
                              ...
                              <p><strong>Status:</strong> Paused <a data-position="bottom" data-delay="50" data-tooltip="Please contact administrator for further details." class="btn-floating waves-effect waves-light tooltipped cyan">Â Â Â Â ?</a></p><p><strong>Note: </strong> description </p>						                               
