            ...
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    ...
                    <ul class="right hide-on-med-and-down">                        
                        <li><a href="#" class="waves-effect waves-block waves-light"><i class="mdi-editor-attach-money">$1000</i></a>
                        </li>
                    </ul>						
                </div>
            </nav>
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <div class="row">
                ...
                <div class="col col s8 m8 l8">
                    <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown">Customer <i class="mdi-navigation-arrow-drop-down right"></i></a>
...
<div>
                <div class="card-panel">
                  <div class="row">
                    <form class="formValidate col s12 m12 l6" id="formValidate" method="post" action="confirm-order.jsp" novalidate="novalidate">
                      <div class="row">
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          <i class="mdi-action-home prefix"></i>
							<textarea name="address" id="address" class="materialize-textarea validate" data-error=".errorTxt1">asdasdasdasd</textarea>
...
<li class="collection-item avatar">
        ...
        <div class="row">
            <div class="col s7">
                <p class="collections-title"><strong>#12123 </strong>Item Name</p>
            </div>
            <div class="col s2">
                <span>3 Pieces</span>
            </div>
	...
	<li class="collection-item avatar"><p><strong>Note: </strong>description</p></li>
</ul>
