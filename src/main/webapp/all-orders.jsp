    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="admin-page.jsp" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Food Menu</a>
            </li>
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-invitation"></i> Orders</a>
                            <div class="collapsible-body">
                                <ul>
								<li class="active"><a href="all-orders.jsp">All Orders</a>
                                </li>
								 <li class=''><a href="all-orders.jsp">orders</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
             ...
             <div class="row">
                <div>
					...
					<li class="collection-item avatar">
                              ...
                              <span class="collection-header">1234</span>
					 ...
					 <li class="collection-item">
							...
							<p><strong>Contact: </strong> 12312312312</p>
							<p><strong>Email: </strong>leviasdasd@asd.com</p>		
							<p><strong>Note: </strong>description</p>								
                      </li>
					  <li class="collection-item">
                            <div class="row">
                            <div class="col s7">
                            <p class="collections-title"><strong>#123123</strong> name item</p>
                            </div>
                            <div class="col s2">
                            <span>4 Pieces</span>
                            </div>
