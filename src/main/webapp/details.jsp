                    ...
                    <form class="formValidate" id="formValidate" method="post" action="#" novalidate="novalidate"class="col s12">
                      <div class="row">
                        <div class="input-field col s12">
                          ...
                          <input name="username" id="username" type="text" value="username" data-error=".errorTxt1">
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          <i class="mdi-action-account-circle prefix"></i>
                          <input name="name" id="name" type="text" value="name" data-error=".errorTxt2">
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          ...
                          <input name="email" id="email" type="email" value="email" data-error=".errorTxt3">
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          <i class="mdi-action-account-circle prefix"></i>
                          <input name="phone" id="phone" type="number" value="contact" data-error=".errorTxt5">
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          ...
                          <textarea name="address" id="address" class="materialize-textarea validate" data-error=".errorTxt6">Address</textarea>
