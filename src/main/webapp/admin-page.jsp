        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="admin-page.jsp" class="brand-logo darken-1"><img src="images/materialize-logo.png" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="admin-page.jsp" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Food Menu</a>
            </li>
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> Orders</a>
                            <div class="collapsible-body">
								...
								<li><a href="all-orders.jsp">orders</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
              ...
              <div>
				<table id="data-table-admin" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
						...
						<input value="name" id="id" name="name" type="text" data-error="name"><div class="id"></div></td>
						<td><div class="input-field col s12 "><label for="price">Price</label>
						<input value="price" id="price" name="price" type="text" data-error="price"><div class="price"></div></td>
						<td><select name="hide">
...
<table>
                    ...
                    <tbody><tr><td><div class="input-field col s12"><label for="name">Name</label>
