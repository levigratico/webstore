                    ...
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> Orders</a>
                            <div class="collapsible-body">
								...
								<li><a href="all-orders.jsp">status</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
...
<table>
					...
					<td>Contact</td>
					<td>Address</td>
					<td><select name="_role">
                      <option value="Administrator" selected>Administrator</option>
                      <option value="Customer">Customer</option>
                    </select></td>
					<td><select name="_verified">
                      <option value="1" selected>Verified</option>
                      <option value="0">Not Verified</option>
                    </select></td>
					<td><select name="_deleted">
                      <option value="1" selected>Disable</option>
                      <option value="0">Enable</option>
                    </select></td>
					<td><label for="balance">Balance</label><input id="balance" name="_balance" value="23000" type="number" data-error=".errorTxt01"><div class="errorTxt01"></div></td></tr>
                    </tbody>
</table>
              </div>
