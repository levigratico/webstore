...
<li class="collection-item avatar">
        ...
        <div class="row">
            <div class="col s7">
                <p class="collections-title"><strong># 23123123 </strong>Item name</p>
            </div>
            <div class="col s2">
                <span>3 Pieces</span>
            </div>
	...
	<li class="collection-item avatar"><p><strong>Note: </strong>Descriptions adasdasdasd</p></li>
...
<input type="hidden" name="address" value="asdasdasasdasdads">
<input type="hidden" name="description" value="asdsadasda">
